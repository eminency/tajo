...
find_program(LLVM_CONFIG_EXECUTABLE llvm-config PATHS ${LLVM_INSTALL_DIR}/bin NO_DEFAULT_PATH)
find_program(LLVM_CLANG_EXECUTABLE clang++ PATHS ${LLVM_INSTALL_DIR}/bin NO_DEFAULT_PATH)
find_program(LLVM_OPT_EXECUTABLE opt PATHS ${LLVM_INSTALL_DIR}/bin NO_DEFAULT_PATH)
